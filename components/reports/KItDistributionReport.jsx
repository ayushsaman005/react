...
function KItDistributionReport() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`${configData.SERVER_URL}api/reports/kit_distribution`);
...
<div className='flex relative w-screen'>
        ...
        {filteredAvaildData?.map(({ user, category, Qty },i) => (
                ...
                <tr>
                            <td className={`${category === "Pharma" && "text-green-400"} ${category === "Faculty" && "text-red-400"} ${category === "Chairperson" && "text-red-400"} ${category === "Delegate" && "text-blue-400"} py-4 px-2 whitespace-nowrap`}>Name: </td>
                            <td className={`${category === "Pharma" && "text-green-400"} ${category === "Faculty" && "text-red-400"} ${category === "Chairperson" && "text-red-400"} ${category === "Delegate" && "text-blue-400"} py-4 whitespace-nowrap`}>{user}</td>
                        </tr>
                        <tr>
...
export default KItDistributionReport