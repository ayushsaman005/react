...
useEffect( () => {
   async function getLoginUser() {
    ...
    return (
        <>
            <h1 className="text-center text-4xl font-bold mt-14 mb-7">Kit distribution</h1>
            {/* scanner */}
            ...
            <button className='"bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded"' onClick={addEntry}>Entry kit distribution</button>
       </div></>
