...
useEffect( () => {
   async function getLoginUser() {
    ...
    return (
        <>
            <h1 className="text-center text-4xl font-bold mt-14 mb-7">Presentation</h1>
            {/* scanner */}
            ...
            {userData[0] ? <><table className="min-w-full divide-y divide-gray-200">
            ...
            <button className='"bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded"' onClick={addEntry}>Entry presentation</button>
       </div></>
            : 
